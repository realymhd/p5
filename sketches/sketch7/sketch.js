...
function setup() {
    ...
    // Initialize parallelogram points
    points = [
        {x: 200, y: 200},
        {x: 400, y: 200},
        {x: 500, y: 400},
...
function mouseDragged() {
    if (isDragging && draggedPoint >= 0) {
        ...
        // Maintain parallelogram properties
        if (draggedPoint === 0) {
            ...
            points[1].x = points[2].x + (points[0].x - points[3].x);
            points[1].y = points[2].y + (points[0].y - points[3].y);
